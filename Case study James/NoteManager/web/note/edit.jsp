...
<div >
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/notes?action=update" method="post">
                ...
                <div class="modal-header" style="background: dimgray">
                    ...
                    <a href="/notes"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button></a>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control" name="name" value="<c:out value='${noteEdit.name}'></c:out>">
                    </div>
                    <div class="form-group">
                        <label>Content</label>
                        <input type="text" class="form-control" name="description" value="<c:out value='${noteEdit.description}'></c:out>">
                    </div>
                    <div class="form-group">
