            ...
            <table class="table table-striped" >
                ...
                <c:forEach var="note" items="${noteList}">
                    <tr>
                        ...
                        <td><span><c:out value="${note.name}"/></span></td>
                        ...
                        <td>
                            <a href="/notes?action=view&id=${note.id}" class="view" title="View" data-toggle="tooltip"><i class="material-icons">&#xE417;</i></a>
                            <a href="/notes?action=edit&id=${note.id}" class="edit" title="Edit" ><i class="material-icons">&#xE254;</i></a>
                            <a href="/notes?action=delete&id=${note.id}" class="delete" title="Delete"><i class="material-icons">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
...
<div id="addNoteModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="/notes?action=create" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="noteTypeId" class="btn btn-secondary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <c:forEach var="noteType" items="${noteTypeList}">
                                <option value="${noteType.id}"><c:out value="${noteType.name}"></c:out></option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
