...
left join dichvu on hopdong.IDdichvu=dichvu.IDdichvu
left join hopdongchitiet on hopdongchitiet.IDhopdong=hopdong.IDhopdong
where  year(ngaylamhopdong)=2019 and ( month(hopdong.ngayketthuchopdong) in (10,11,12) and month(ngaylamhopdong) not in (1,6));
...
select tendichvudikem,count(hopdongchitiet.soluong) as soluong
 ...
 select hopdong.IDhopdong,loaidichvu.tenloaidichvu,tendichvudikem,count(hopdongchitiet.soluong) as solansudung
 from hopdongchitiet 
 join hopdong on hopdong.IDhopdong=hopdongchitiet.IDhopdong
 join khachhang on khachhang.IDkhachhang=hopdong.IDkhachhang
 join dichvudikem on dichvudikem.IDdichvudikem=hopdongchitiet.IDdichvudikem
 ...
 select nhanvien.IDnhanvien,nhanvien.hoten,trinhdo,tenbophan,nhanvien.sodienthoai,nhanvien.diachi,  count(IDhopdong)
 from nhanvien 
