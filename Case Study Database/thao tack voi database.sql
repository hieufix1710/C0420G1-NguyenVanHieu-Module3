...
(3,2,2,2,'2020-07-10','2020-12-30',2000000,5000000),
(4,1,2,1,'2020-05-10','2020-12-30',2000000,5000000),
(5,2,1,1,'2020-03-10','2020-12-30',2000000,5000000);
...
#task 9
select sum(year(ngaylamhopdong)=2020 and month(ngaylamhopdong)=8)*(select sum(tongtien) where month(ngaylamhopdong)=8 and year(ngaylamhopdong)=2020) as 'doanh thu'
from hopdong;
